...
//            }
//            $.ajax({
//                url: '/Vendor/UpdateIntegrationRequests',
//                type: "Get",
//                success: function (data) {
        ...
        if (result.isConfirmed) {
            Swal.fire({
                ...
                didOpen: () => {
                    ...
                    $.ajax({
                        url: '/Vendor/StartTechnicalEvaluation',
...
function ShowModalOfFillTechnicalEvaluation(IntegReqId) {
    ...
    Swal.fire({
        ...
        didOpen: () => {
            ...
            $.ajax({
                url: '/Vendor/GetVendorIntegrationRequestById',
                data: { 'intReqId': IntegReqId },
                type: "Get",
                success: function (data) {
                    const content2 = Swal.getContent()
...
$(document).ready(function () {
    //$('#IntegrationrequestsList3').DataTable({
    //    "order": [[2, "desc"]],
    //});
    if ($.fn.dataTable.isDataTable('#IntegrationrequestsList')) { table = $('#IntegrationrequestsList').DataTable(); } else { table = $('#IntegrationrequestsList').DataTable({ "order": [[2, "desc"]] }); }
            ...
            if (result.isConfirmed) {
                ...
                Swal.fire({
                    ...
                    didOpen: () => {
                        ...
                        $.ajax({
                            url: '/Vendor/SubmitIntegrationTechnicalEvaluation',
        ...
        if (result.isConfirmed) {
            Swal.fire({
                ...
                didOpen: () => {
                    ...
                    $.ajax({
                        url: '/Vendor/MarkAsReadyForIntegration',
                        data: { 'IntegReqId': IntegReqId },
                        type: "Get",
                        success: function (data) {
                            const content2 = Swal.getContent()
...
function StartIntegrationWorkshop(IntegReqId) {
    Swal.fire({
        ...
        showDenyButton: true,
        showCancelButton: false,
        confirmButtonText: `Start Workshop`,
        denyButtonText: `Cancel`,
        showLoaderOnConfirm: true,
        allowOutsideClick: () => !Swal.isLoading()
    }).then((result) => {
        if (result.isConfirmed) {
            Swal.fire({
                ...
                didOpen: () => {
                    ...
                    $.ajax({
                        url: '/Vendor/StartIntegrationWorkshop',
                        data: { 'IntegReqId': IntegReqId },
                        type: "Get",
                        success: function (data) {
                            const content2 = Swal.getContent()
        ...
        if (result.isConfirmed) {
            Swal.fire({
                ...
                didOpen: () => {
                    ...
                    $.ajax({
                        url: '/Vendor/StartIntegrationQualityCheck',
                        data: { 'IntegReqId': IntegReqId },
                        type: "Get",
                        success: function (data) {
                            const content2 = Swal.getContent()
                            if (content2) {
                                const b2 = content2.querySelector('b')
                                if (b2) {
                                    b2.textContent = 'Updating the status'
                                }
                            }
                            $.ajax({
                                url: '/Vendor/UpdateIntegrationRequests',
        ...
        if (result.isConfirmed) {
            Swal.fire({
                ...
                didOpen: () => {
                    ...
                    $.ajax({
                        url: '/Vendor/CompleteIntegrationQualityCheck',
                        data: { 'IntegReqId': IntegReqId },
                        type: "Get",
                        success: function (data) {
                            const content2 = Swal.getContent()
        ...
        if (result.isConfirmed) {
            Swal.fire({
                ...
                didOpen: () => {
                    ...
                    $.ajax({
                        url: '/Vendor/StartFirstBatchQualityCheck',
                        data: { 'IntegReqId': IntegReqId },
                        type: "Get",
                        success: function (data) {
                            const content2 = Swal.getContent()
        ...
        if (result.isConfirmed) {
            Swal.fire({
                ...
                didOpen: () => {
                    ...
                    $.ajax({
                        url: '/Vendor/CompleteFirstBatchQualityCheck',
                        data: { 'IntegReqId': IntegReqId },
                        type: "Get",
                        success: function (data) {
                            const content2 = Swal.getContent()
